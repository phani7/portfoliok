    ...
    <nav className="navbar">
      <div className="nav-wrapper">
        <div className="logo">
          <Link to="/">
            <img
              src="https://res.cloudinary.com/drxqukrrc/image/upload/v1657206524/depositphotos_339298604-stock-illustration-initial-alphabet-logo-design-vector_jiga1w.webp?raw=true"
              alt="brand"
            />
          </Link>
        </div>
